...
describe('test primo-explore-location-item-after', function() {
    ...
    it('The following should show a google maps iframe consistent with the location library', function() {
        browser.get('http://localhost:8003/primo-explore/?query=any,contains,journal%20of&tab=default_tab&search_scope=default_scope&sortby=rank&vid=Auto1&facet=rtype,include,books&lang=en_US&offset=0&noSilentLogin=true');
